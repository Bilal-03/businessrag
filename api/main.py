...
def create_app() -> FastAPI:
    ...
    # responses generated by ServerErrorMiddleware. Without this outer
    # wrapper, a backend exception is surfaced by browsers as a misleading
    # CORS failure and hides the useful API error response.
