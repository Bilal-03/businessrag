...
- Compliance Plan shows only reviewed, published, effective obligations with source citations; empty/unavailable source state remains explicit and the legacy checklist stays hidden.
